...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function() {
		...
		this.htPopupOption.sProperties = "left=0,top=0,width=385,height=459,scrollbars=yes,location=no,status=0,resizable=no";
	...
	makePopupURL : function() {
		var sPopupUrl = this.oApp.htOptions.getContextPath+'editorImage.do?viewTp='+this.oApp.htOptions.viewTp+'&viewId='+this.oApp.htOptions.viewId;
		return sPopupUrl;
	},
